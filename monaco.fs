...
module Monaco =
    ...
    type [<AllowNullLiteral>] CancellationTokenSourceStatic =
        [<Emit "new $0($1...)">] abstract Create: ?parent: CancellationToken -> CancellationTokenSource
    ...
    type [<AllowNullLiteral>] Uri =
        ...
        /// <summary>Creates a string representation for this Uri. It's guaranteed that calling
        /// `Uri.parse` with the result of this function creates an Uri which is equal
        /// to this Uri.
        /// 
        /// * The result shall *not* be used for display purposes but for externalization or transport.
        /// * The result will be encoded using the percentage encoding and encoding happens mostly
        /// ignore the scheme-specific encoding rules.</summary>
    ...
    type [<AllowNullLiteral>] UriStatic =
        ...
        /// <summary>Creates a new Uri from a string, e.g. `http://www.msft.com/some/path`,
        ...
        /// <summary>Creates a new Uri from a file system path, e.g. `c:\my\files`,
    ...
    type [<AllowNullLiteral>] IMarkdownString =
        ...
        abstract uris: TypeLiteral_11 option with get, set
    ...
    type [<AllowNullLiteral>] Position =
        ...
        /// column (the first character in a line is between column 1 and column 2)
        abstract column: float
        /// <summary>Create a new postion from this position.</summary>
    ...
    type [<AllowNullLiteral>] RangeStatic =
        ...
        abstract lift: range: obj option -> obj
    ...
    module Editor =
        ...
        type [<AllowNullLiteral>] ICursorStateComputer =
            ...
            [<Emit "$0($1...)">] abstract Invoke: inverseEditOperations: ResizeArray<IIdentifiedSingleEditOperation> -> ResizeArray<Selection> option
        ...
        type [<AllowNullLiteral>] ITextModel =
            ...
            /// <summary>Perform a minimum amount of operations, in order to transform the decorations
            ...
            /// <summary>Gets all the decorations in a range as an array. Only `startLineNumber` and `endLineNumber` from `range` are used for filtering.
            ...
            abstract pushEditOperations: beforeCursorState: ResizeArray<Selection> * editOperations: ResizeArray<IIdentifiedSingleEditOperation> * cursorStateComputer: ICursorStateComputer -> ResizeArray<Selection> option
        ...
        type [<AllowNullLiteral>] IEditOperationBuilder =
            ...
            abstract addEditOperation: range: Range * text: string option -> unit
            ...
            /// <param name="range">The range to replace (delete). May be empty to represent a simple insert.</param>
            /// <param name="text">The text to replace with. May be null to represent a simple delete.</param>
            abstract addTrackedEditOperation: range: Range * text: string option -> unit
        ...
        type [<AllowNullLiteral>] IModelTokensChangedEvent =
            abstract tokenizationSupportChanged: bool
        ...
        type [<AllowNullLiteral>] IEditorScrollbarOptions =
            ...
            /// Defaults to 'auto'.
            abstract vertical: U3<string, string, string> option with get, set
            /// Render horizontal scrollbar.
            /// Defaults to 'auto'.
            abstract horizontal: U3<string, string, string> option with get, set
        ...
        type [<AllowNullLiteral>] ISuggestOptions =
            ...
            abstract maxVisibleSuggestions: bool option with get, set
            /// Names of suggestion types to filter.
            abstract filteredTypes: Record<string, bool> option with get, set

        type [<AllowNullLiteral>] IGotoLocationOptions =
            /// Control how goto-command work when having multiple results.
            abstract multiple: U3<string, string, string> option with get, set
        ...
        type [<AllowNullLiteral>] IEditorOptions =
            ...
            abstract tabCompletion: U4<bool, string, string, string> option with get, set
        ...
        type [<AllowNullLiteral>] InternalEditorScrollbarOptions =
            ...
            abstract fastScrollSensitivity: float
        ...
        type [<AllowNullLiteral>] InternalEditorFindOptions =
            ...
            abstract addExtraSpaceOnTop: bool
        ...
        type [<AllowNullLiteral>] InternalGoToLocationOptions =
            abstract multiple: U3<string, string, string>
        ...
        type [<AllowNullLiteral>] InternalSuggestOptions =
            ...
            abstract localityBonus: bool
            abstract shareSuggestSelections: bool
            abstract showIcons: bool
            abstract maxVisibleSuggestions: float
            abstract filteredTypes: Record<string, bool>

        type [<AllowNullLiteral>] InternalParameterHintOptions =
            abstract enabled: bool
            abstract cycle: bool
        ...
        type [<AllowNullLiteral>] InternalEditorViewOptions =
            ...
            abstract renderCustomLineNumbers: (float -> string) option
            abstract renderFinalNewline: bool
            ...
            abstract cursorSmoothCaretAnimation: bool
        ...
        type [<AllowNullLiteral>] EditorContribOptions =
            ...
            abstract parameterHints: InternalParameterHintOptions
            ...
            abstract tabCompletion: U3<string, string, string>
            abstract suggest: InternalSuggestOptions
            abstract gotoLocation: InternalGoToLocationOptions
        ...
        type [<AllowNullLiteral>] InternalEditorOptions =
            ...
            abstract autoClosingBrackets: EditorAutoClosingStrategy
            abstract autoClosingQuotes: EditorAutoClosingStrategy
            abstract autoSurround: EditorAutoSurroundStrategy
            ...
            abstract copyWithSyntaxHighlighting: bool
        ...
        type [<AllowNullLiteral>] IConfigurationChangedEvent =
            ...
            abstract autoClosingQuotes: bool
            abstract autoSurround: bool
            abstract autoIndent: bool
            abstract useTabStops: bool
            abstract tabFocusMode: bool
            abstract dragAndDrop: bool
        ...
        type [<AllowNullLiteral>] ICodeEditor =
            ...
            abstract onCompositionStart: listener: (unit -> unit) -> IDisposable
            /// An event emitted after composition has ended.
            abstract onCompositionEnd: listener: (unit -> unit) -> IDisposable
            ...
            /// <param name="source">The source of the call.</param>
            abstract executeCommands: source: string * commands: ResizeArray<ICommand option> -> unit
            ...
            abstract getScrolledVisiblePosition: position: IPosition -> TypeLiteral_06 option
    ...
    module Languages =
        ...
        type [<AllowNullLiteral>] CodeActionProvider =
            ...
            abstract provideCodeActions: model: Editor.ITextModel * range: Range * context: CodeActionContext * token: CancellationToken -> U2<ResizeArray<U2<Command, CodeAction>>, Promise<ResizeArray<U2<Command, CodeAction>>>>
        ...
        module ProviderResult =
            let ofTOption v: ProviderResult<'T> = v |> Microsoft.FSharp.Core.Option.map U2.Case1
            ...
            let ofThenableOption v: ProviderResult<'T> = v |> Microsoft.FSharp.Core.Option.map U2.Case2
        ...
        type [<AllowNullLiteral>] CompletionItemProvider =
            ...
            abstract resolveCompletionItem: model: Editor.ITextModel * position: Position * item: CompletionItem * token: CancellationToken -> ProviderResult<CompletionItem>
        ...
        type [<AllowNullLiteral>] SignatureHelpProvider =
            ...
            abstract provideSignatureHelp: model: Editor.ITextModel * position: Position * token: CancellationToken * context: SignatureHelpContext -> ProviderResult<SignatureHelp>
        ...
        [<RequireQualifiedAccess; CompilationRepresentation(CompilationRepresentationFlags.ModuleSuffix)>]
        module Definition =
            let ofLocation v: Definition = v |> U3.Case1
            let isLocation (v: Definition) = match v with U3.Case1 _ -> true | _ -> false
            let asLocation (v: Definition) = match v with U3.Case1 o -> Some o | _ -> None
            let ofLocationArray v: Definition = v |> U3.Case2
            let isLocationArray (v: Definition) = match v with U3.Case2 _ -> true | _ -> false
            let asLocationArray (v: Definition) = match v with U3.Case2 o -> Some o | _ -> None
            let ofLocationLinkArray v: Definition = v |> U3.Case3
            let isLocationLinkArray (v: Definition) = match v with U3.Case3 _ -> true | _ -> false
            let asLocationLinkArray (v: Definition) = match v with U3.Case3 o -> Some o | _ -> None
        ...
        type [<AllowNullLiteral>] ResourceFileEdit =
            ...
            abstract options: TypeLiteral_09 with get, set
        ...
        type [<AllowNullLiteral>] CodeLensProvider =
            ...
            abstract provideCodeLenses: model: Editor.ITextModel * token: CancellationToken -> ProviderResult<ResizeArray<ICodeLensSymbol>>
            abstract resolveCodeLens: model: Editor.ITextModel * codeLens: ICodeLensSymbol * token: CancellationToken -> ProviderResult<ICodeLensSymbol>
        ...
        type [<AllowNullLiteral>] IMonarchLanguage =
            ...
            abstract tokenizer: TypeLiteral_10 with get, set
        ...
        [<RequireQualifiedAccess; CompilationRepresentation(CompilationRepresentationFlags.ModuleSuffix)>]
        module IMonarchLanguageAction =
            let ofIShortMonarchLanguageAction v: IMonarchLanguageAction = v |> U4.Case1
            let isIShortMonarchLanguageAction (v: IMonarchLanguageAction) = match v with U4.Case1 _ -> true | _ -> false
            let asIShortMonarchLanguageAction (v: IMonarchLanguageAction) = match v with U4.Case1 o -> Some o | _ -> None
            let ofIExpandedMonarchLanguageAction v: IMonarchLanguageAction = v |> U4.Case2
            let isIExpandedMonarchLanguageAction (v: IMonarchLanguageAction) = match v with U4.Case2 _ -> true | _ -> false
            let asIExpandedMonarchLanguageAction (v: IMonarchLanguageAction) = match v with U4.Case2 o -> Some o | _ -> None
            let ofIShortMonarchLanguageActionArray v: IMonarchLanguageAction = v |> U4.Case3
            let isIShortMonarchLanguageActionArray (v: IMonarchLanguageAction) = match v with U4.Case3 _ -> true | _ -> false
            let asIShortMonarchLanguageActionArray (v: IMonarchLanguageAction) = match v with U4.Case3 o -> Some o | _ -> None
            let ofIExpandedMonarchLanguageActionArray v: IMonarchLanguageAction = v |> U4.Case4
            let isIExpandedMonarchLanguageActionArray (v: IMonarchLanguageAction) = match v with U4.Case4 _ -> true | _ -> false
            let asIExpandedMonarchLanguageActionArray (v: IMonarchLanguageAction) = match v with U4.Case4 o -> Some o | _ -> None
    ...
    type [<AllowNullLiteral>] TypeLiteral_11 =
        [<Emit "$0[$1]{{=$2}}">] abstract Item: href: string -> UriComponents with get, set
